...
class LiteraryFictionPage extends StatefulWidget {
  LiteraryFictionPage(BuildContext context);

  @override
  _LiteraryFictionPageState createState() => _LiteraryFictionPageState();
}

class _LiteraryFictionPageState extends State<LiteraryFictionPage> {
  ...
  Future<void> fetchAcademicBooks() async {
    ...
    try {
      ...
      var result = await booksApiService.volumes.list('Literary Fiction');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Literary Fiction books'),
        actions: [
          IconButton(
            icon: Icon(
