...
class HistoricalFictionPage extends StatefulWidget {
  HistoricalFictionPage(BuildContext context);

  @override
  _HistoricalFictionPageState createState() => _HistoricalFictionPageState();
}

class _HistoricalFictionPageState extends State<HistoricalFictionPage> {
  ...
  Future<void> fetchAcademicBooks() async {
    ...
    try {
      ...
      var result = await booksApiService.volumes.list('History');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Historical Fiction books'),
        actions: [
          IconButton(
            icon: Icon(
